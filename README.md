<p align="center">
    <img src="fig_method.svg" alt="SemEx Methodology"/>
  </p>
...
---
  ...
  Examples:
  - `semex-B-n` means *base explanation using neutral replacements*
  - `semex-A-n` means *aspect-based explanation using neutral replacements*
  - `semex-R-n` means *reference-based explanation using neutral replacements*
  - `semex-B-a` means *base explanation using antonym replacements*
